...
export ARCH=arm64
export KBUILD_BUILD_USER=DenomSly
export KBUILD_BUILD_HOST=Android_Builder_Kernel
...
make O=out ARCH=arm64 vendor/sweet_perf_defconfig
make -j$(nproc --all) \
       O=out \
       ARCH=arm64 \
       AR=llvm-ar \
